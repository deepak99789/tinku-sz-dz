...
# Har alert-event type zone ki KIS status-stage se related hai. Isse "🎯 Zone
# Status Filter" (upar) sirf chart/log table tak hi limited nahi rehta -
# Telegram + in-app (toast/sound/log) alerts par bhi apply hota hai. e.g.
# filter me sirf "Fresh Zone" select karne par ab sirf zone_found/entered
# events jayenge - sl_hit/tp_hit Telegram par nahi aayenge.
EVENT_STATUS_MAP = {
    "zone_found": "active",
    "pre_alert": "active",
    "entered": "active",
